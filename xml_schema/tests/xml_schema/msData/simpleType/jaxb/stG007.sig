...
CLSS public javasoft.sqe.tests.simpletype.stg007.Root
...
cons public Root()
fld protected java.util.List<java.math.BigInteger> fooTest
...
meth public java.util.List<java.math.BigInteger> getFooTest()

 ...
 * Jmpp library and BuildProperty class.
 */
public class JmppBuildPropertiesProvider implements BuildPropertiesProvider {

    public String getBuildProperty(String name) {
        return getBuildProperty(name, null);
    }

    public String getBuildProperty(String name, String defaultValue) {
        return BuildProperties.getPrefixString("jmppconv", name, defaultValue);
    }

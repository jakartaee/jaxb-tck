...
/**
 * <b>DefaultIRPFactorySpi</b> class that provides default
...
public class DefaultIRPFactorySpi implements IRPFactorySpi {

    /**
     * Returns LibLinker instance.
     */
    public IRProcessor getProcessor(Properties props) {
        return new LibLinker(props);
    }

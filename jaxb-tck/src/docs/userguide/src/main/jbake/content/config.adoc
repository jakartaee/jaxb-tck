...
jck.env.jaxb.schemagen.run.jxcCmd=/bin/sh
  /workspace/XMLB-TCK-4.0/bin/schemagen.sh
...
jck.env.jaxb.xsd_compiler.testCompile.xjcCmd=/bin/sh
  /workspace/XMLB-TCK-4.0/bin/xjc.sh
...
`/bin/sh /workspace/XMLB-TCK-4.0/bin/xjc.sh`
...
`c:\workspace\XMLB-TCK-4.0\bin\xjc.bat`
...
Java Architecture for XML Binding 4.0
...
`/bin/sh /workspace/XMLB-TCK-4.0/bin/schemagen.sh`
...
`c:\workspace\XMLB-TCK-4.0\bin\schemagen.bat`

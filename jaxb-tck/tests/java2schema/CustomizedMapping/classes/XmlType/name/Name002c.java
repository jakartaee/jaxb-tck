...
package javasoft.sqe.tests.java2schema.CustomizedMapping.classes.XmlType.name.Name002;
 ...
 */
@XmlRootElement        
@XmlType(name="##default", propOrder={"b001", "bt01", "d001", "f001", "i001", "l001",
                            "s001", "sh01"})
public class Name002c {

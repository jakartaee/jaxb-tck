...
package javasoft.sqe.tests.java2schema.CustomizedMapping.classes.XmlType.name.Name004;
 ...
 */
@XmlRootElement        
@XmlType(name="customizedName004c", propOrder={"b001", "bt01", "d001", "f001", "i001", "l001",
                            "s001", "sh01"})        
public class Name004c {

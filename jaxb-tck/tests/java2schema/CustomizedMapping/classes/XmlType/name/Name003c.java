...
package javasoft.sqe.tests.java2schema.CustomizedMapping.classes.XmlType.name.Name003;

import jakarta.xml.bind.annotation.*;

/**
 * Mapping: Class to Complex Type Definition
 * If @XmlType.name() is not defined, then a class name 
 * is mapped to an XML name by decapitalization using 
 * java.beans.Introspector.decapitalize(class name).
 */
@XmlRootElement        
@XmlType(propOrder={"b001", "bt01", "d001", "f001", "i001", "l001",
                            "s001", "sh01"})        
public class Name003c {

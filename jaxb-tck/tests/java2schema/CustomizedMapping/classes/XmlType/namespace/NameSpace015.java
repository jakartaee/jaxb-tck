 ...
 * {target namespace} ::=
 * if @XmlType.namespace() is ##default && @XmlType.name() is empty string and class is
 * annotated with @XmlRootElement, then as specified in Table Mapping: Class to Element Declaration,
 * if @XmlRootElement.namespace() is not ##default, then @XmlRootElement.namespace()
 **/
@XmlType(propOrder={"b001", "bt01", "d001", "f001", "i001", "l001", "s001", "sh01"},
         namespace="##default")
@XmlRootElement(namespace="http://www.example.com/NameSpace")
public class NameSpace015 {

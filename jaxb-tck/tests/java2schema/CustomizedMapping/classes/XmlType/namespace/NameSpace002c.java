...
package javasoft.sqe.tests.java2schema.CustomizedMapping.classes.XmlType.namespace.NameSpace002;
...
@XmlType(namespace="##default", name="", propOrder={  "b001", "bt01", "d001", 
        "f001", "i001", "l001", "s001", "sh01"})
@XmlRootElement(namespace="##default")
public class NameSpace002c {

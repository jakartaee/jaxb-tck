...
meth public abstract <%0 extends jakarta.xml.bind.annotation.adapters.XmlAdapter<?,?>> void setAdapter({%%0})
...
meth public <%0 extends jakarta.xml.bind.annotation.adapters.XmlAdapter<?,?>> void setAdapter({%%0})

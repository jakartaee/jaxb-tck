...
** link:config.html#GBFUY[4.2 Using the JavaTest Harness Software]
...
*** link:using.html#GBFWH[5.1.1 To Start JavaTest in Command-Line Mode]
...
*** link:using.html#GBFVL[5.2.2 To Run a Subset of Tests in Batch Mode Based on Prior Result Status]
...
*** link:using.html#[5.5.2 Viewing an Existing Test Report]

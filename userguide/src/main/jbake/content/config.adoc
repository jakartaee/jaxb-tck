...
[source,oac_no_warn]
----
TESTSUITE=/workspace/XMLB-TCK-3.1
WORKDIR=/workspace/XMLB-TCK-3.1/batch-multiJVM/work
...
jck.env.jaxb.schemagen.run.jxcCmd=/bin/sh
  /workspace/XMLB-TCK-3.1/linux/bin/schemagen.sh
...
jck.env.jaxb.xsd_compiler.testCompile.xjcCmd=/bin/sh
  /workspace/XMLB-TCK-3.1/linux/bin/xjc.sh
...
`/bin/sh /workspace/XMLB-TCK-3.1/linux/bin/xjc.sh`
...
`c:\workspace\XMLB-TCK-3.1\win32\bin\xjc.bat`
...
`/bin/sh /workspace/XMLB-TCK-3.1/linux/bin/schemagen.sh`
...
`c:\workspace\XMLB-TCK-3.1\win32\bin\schemagen.bat`

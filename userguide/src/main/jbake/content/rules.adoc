...
* link:#CJABAHYZ[Reference Implementation for {TechnologyShortName} {TechnologyVersion}]
...
|Compiler|A software development tool that implements or incorporates a
compilation function from source code written in the Java
programming language, as specified by Oracle, into Executable
Output.
...
|Reference Implementation |The prototype or proof-of-concept implementation of the
Specifications.

|Rules |These definitions and rules in this Compatibility Requirements
section of this User's Guide.

|Schema Compiler |A schema compiler generates Java source files or compiled
classes that represent XML data described by W3C XML Schema recommendation
[XSD Part 1][XSD Part 2].

|Schema Compiler Output |The output of a Schema Compiler intended to be run in
combination with the Libraries.

|Schema Generator |A software development tool that maps a set of existing Java
sources or class files to Schema Generator Output. The
mapping is described by program annotations. The Schema
Generator can be invoked directly by a programmer without
programming.

|Schema Generator Output |The output of Schema Generator intended to be a W3C XML
Schema defined in the XML Schema recommendation [XSD Part
1][XSD Part 2]. The output of a Schema Generator that is in the
format defined by the W3C XML Schema recommendation [XSD
Part 1][XSD Part 2].
...
The {TechnologyShortName} {TechnologyVersion} specification endorses and builds
upon the following external specifications:

* link:https://www.w3.org/TR/REC-xml/[XML 1.0 Recommendation (Fifth Edition)]
* link:https://www.w3.org/TR/1999/REC-xml-names-19990114/[XML Namespaces 1.0 Recommendation]
* link:https://www.w3.org/TR/2000/REC-DOM-Level-2-Core-20001113/[DOM Level 2 Core Recommendation]
* link:https://www.w3.org/TR/2004/REC-xmlschema-1-20041028/[XML Schema Part 1: Structures]
* link:https://www.w3.org/TR/2004/REC-xmlschema-2-20041028/[XML Schema Part 2: Datatypes]
* link:https://www.w3.org/TR/2004/REC-xml-infoset-20040204/[XML Information Set, John Cowan and Richard Tobin, eds., W3C, 16 March 2001]
* link:https://www.w3.org/TR/1999/REC-xpath-19991116/[XML Path Language, James Clark and Steve DeRose, eds., W3C, 16 November 1999]
* link:http://www.saxproject.org/[SAX 2.0 API]
* link:http://www.saxproject.org/[Package org.xml.sax]
* link:http://www.saxproject.org/sax2-ext.html[SAX 2 Extensions]
* link:http://www.saxproject.org/apidoc/org/xml/sax/ext/package-summary.html[Package org.xml.sax.ext]
...
[[CJABAHYZ]][[reference-implementation]]

2.6 Reference Implementation for {TechnologyShortName} {TechnologyVersion}
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The designated Reference Implementations for compatibility testing of Java SE 9
Platform Implementations are the following binaries:

* The Reference Implementation of Java SE 9, which is defined on the following
operating systems and architectures:
** Oracle Linux 7 x64
** Windows 10 x64

* link:http://www.saxproject.org/sax2-ext.html[{TechnologyShortName} {TechnologyVersion}]
binaries that are run on Reference Implementation of Java SE 8.0.

...
"""
  ...
  parameters {
    ...
    string(name: 'JAF_BUNDLE_URL',
           defaultValue: 'https://repo1.maven.org/maven2/jakarta/activation/jakarta.activation-api/2.1.4/jakarta.activation-api-2.1.4.jar',
    ...
    string(name: 'TCK_BUNDLE_FILE_NAME', 
           defaultValue: 'jakarta-xml-binding-tck-4.0.3.zip',

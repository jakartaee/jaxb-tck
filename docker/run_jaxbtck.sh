...
wget https://repo1.maven.org/maven2/org/checkerframework/checker/3.4.1/checker-3.4.1.jar -O ${WORKSPACE}/checker.jar

unzip -o latest-glassfish.zip
chmod -R 777 glassfish6

mkdir -p JAXB_REPORT/JAXB-TCK

cd jaxb-tck-build/unzip/JAXB-TCK-2.3/lib

$JAVA_HOME/bin/java -jar javatest.jar -batch -testsuite $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-2.3 -open javasoft-multiJVM.jti -workdir -create $WORKSPACE/batch-multiJVM/work -set jck.env.jaxb.xsd_compiler.skipValidationOptional Yes -set jck.env.jaxb.xsd_compiler.testCompile.xjcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-2.3/linux/bin/xjc.sh" -set jck.env.jaxb.schemagen.run.jxcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-2.3/linux/bin/schemagen.sh" -set jck.env.jaxb.testExecute.otherEnvVars "JAVA_HOME=/opt/jdk1.8.0_191 JAXB_HOME=$WORKSPACE/glassfish6/glassfish JAXB_ENDORSED=$WORKSPACE/glassfish6/glassfish/modules/jakarta.xml.bind-api.jar" -set jck.env.jaxb.classes.jaxbClasses "$WORKSPACE/glassfish6/glassfish/modules/jakarta.xml.bind-api.jar $WORKSPACE/glassfish6/glassfish/modules/jaxb-osgi.jar $WORKSPACE/glassfish6/glassfish/modules/jersey-media-jaxb.jar $WORKSPACE/glassfish6/glassfish/modules/jakarta.activation.jar ${WORKSPACE}/checker.jar" -set jck.env.jaxb.classes.needJaxbClasses Yes -runtests

$JAVA_HOME/bin/java -jar javatest.jar -batch -testsuite $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-2.3 -open javasoft-multiJVM.jti -workdir $WORKSPACE/batch-multiJVM/work -set jck.env.jaxb.xsd_compiler.skipValidationOptional Yes -set jck.env.jaxb.xsd_compiler.testCompile.xjcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-2.3/linux/bin/xjc.sh" -set jck.env.jaxb.schemagen.run.jxcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-2.3/linux/bin/schemagen.sh" -set jck.env.jaxb.testExecute.otherEnvVars "JAVA_HOME=/opt/jdk1.8.0_191 JAXB_HOME=$WORKSPACE/glassfish6/glassfish JAXB_ENDORSED=$WORKSPACE/glassfish6/glassfish/modules/jakarta.xml.bind-api.jar" -set jck.env.jaxb.classes.jaxbClasses "$WORKSPACE/glassfish6/glassfish/modules/jakarta.xml.bind-api.jar $WORKSPACE/glassfish6/glassfish/modules/jaxb-osgi.jar $WORKSPACE/glassfish6/glassfish/modules/jersey-media-jaxb.jar $WORKSPACE/glassfish6/glassfish/modules/jakarta.activation.jar ${WORKSPACE}/checker.jar" -set jck.env.jaxb.classes.needJaxbClasses Yes -set jck.priorStatus.needStatus Yes -set jck.priorStatus.status not_run -runtests

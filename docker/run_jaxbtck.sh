...
cd jaxb-tck-build/unzip/JAXB-TCK-3.0/tests/api/signaturetest

####RUN tests with GLassfish JAXB
if [[ "$RUNTIME" == "Glassfish" ]]; then
	$JAVA_HOME/bin/java -jar $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/lib/javatest.jar -batch -testsuite $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0 -open $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/lib/javasoft-multiJVM.jti -workdir -create $WORKSPACE/batch-multiJVM/work -set jck.env.jaxb.xsd_compiler.skipValidationOptional Yes -set jck.env.jaxb.xsd_compiler.testCompile.xjcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/linux/bin/xjc.sh" -set jck.env.jaxb.schemagen.run.jxcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/linux/bin/schemagen.sh" -set jck.env.jaxb.testExecute.otherEnvVars "JAVA_HOME=/opt/jdk1.8.0_191 JAXB_HOME=$WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish" -set jck.env.jaxb.classes.jaxbClasses "$WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jakarta.xml.bind-api.jar $WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jaxb-osgi.jar $WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jersey-media-jaxb.jar $WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jakarta.activation.jar ${WORKSPACE}/checker.jar" -set jck.env.jaxb.classes.needJaxbClasses Yes -runtests

	$JAVA_HOME/bin/java -jar $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/lib/javatest.jar -batch -testsuite $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0 -open $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/lib/javasoft-multiJVM.jti -workdir $WORKSPACE/batch-multiJVM/work -set jck.env.jaxb.xsd_compiler.skipValidationOptional Yes -set jck.env.jaxb.xsd_compiler.testCompile.xjcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/linux/bin/xjc.sh" -set jck.env.jaxb.schemagen.run.jxcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/linux/bin/schemagen.sh" -set jck.env.jaxb.testExecute.otherEnvVars "JAVA_HOME=/opt/jdk1.8.0_191 JAXB_HOME=$WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish" -set jck.env.jaxb.classes.jaxbClasses "$WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jakarta.xml.bind-api.jar $WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jaxb-osgi.jar $WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jersey-media-jaxb.jar $WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jakarta.activation.jar ${WORKSPACE}/checker.jar" -set jck.env.jaxb.classes.needJaxbClasses Yes -set jck.priorStatus.needStatus Yes -set jck.priorStatus.status not_run -runtests

	$JAVA_HOME/bin/java -jar $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/lib/javatest.jar -workdir $WORKSPACE/batch-multiJVM/work -writereport $WORKSPACE/JAXB_REPORT/JAXB-TCK
else 
####RUN tests with standalone JAXB RI
	$JAVA_HOME/bin/java -jar $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/lib/javatest.jar -batch -testsuite $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0 -open $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/lib/javasoft-multiJVM.jti -workdir -create $WORKSPACE/batch-multiJVM/work -set jck.env.jaxb.xsd_compiler.skipValidationOptional Yes -set jck.env.jaxb.xsd_compiler.testCompile.xjcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/linux/bin/xjc.sh" -set jck.env.jaxb.schemagen.run.jxcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/linux/bin/schemagen.sh" -set jck.env.jaxb.testExecute.otherEnvVars "JAVA_HOME=/opt/jdk1.8.0_191 JAXB_HOME=$WORKSPACE/jaxb-ri" -set jck.env.jaxb.classes.jaxbClasses "${WORKSPACE}/checker.jar $WORKSPACE/jaxb-ri/mod/jakarta.xml.bind-api.jar $WORKSPACE/jaxb-ri/mod/jaxb-impl.jar $WORKSPACE/jaxb-ri/mod/jaxb-jxc.jar $WORKSPACE/jaxb-ri/mod/jakarta.activation.jar $WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jersey-media-jaxb.jar" -set jck.env.jaxb.classes.needJaxbClasses Yes -runtests

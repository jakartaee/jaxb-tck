...
####RUN tests with JAXB RI
$JAVA_HOME/bin/java -jar javatest.jar -batch -testsuite $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0 -open javasoft-multiJVM.jti -workdir -create $WORKSPACE/batch-multiJVM/work -set jck.env.jaxb.xsd_compiler.skipValidationOptional Yes -set jck.env.jaxb.xsd_compiler.testCompile.xjcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/linux/bin/xjc.sh" -set jck.env.jaxb.schemagen.run.jxcCmd "/bin/sh $WORKSPACE/jaxb-tck-build/unzip/JAXB-TCK-3.0/linux/bin/schemagen.sh" -set jck.env.jaxb.testExecute.otherEnvVars "JAVA_HOME=/opt/jdk1.8.0_191 JAXB_HOME=$WORKSPACE/jaxb-ri JAXB_ENDORSED=$WORKSPACE/jaxb-ri/mod/jakarta.xml.bind-api.jar" -set jck.env.jaxb.testExecute.otherOpts "-Djava.endorsed.dirs=$WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/endorsed/" -set jck.env.jaxb.classes.jaxbClasses "${WORKSPACE}/checker.jar $WORKSPACE/jaxb-ri/mod/jakarta.xml.bind-api.jar $WORKSPACE/jaxb-ri/mod/jaxb-impl.jar $WORKSPACE/jaxb-ri/mod/jaxb-jxc.jar $WORKSPACE/jaxb-ri/mod/jakarta.activation.jar $WORKSPACE/${TOP_GLASSFISH_DIR}/glassfish/modules/jersey-media-jaxb.jar" -set jck.env.jaxb.classes.needJaxbClasses Yes -runtests
